...
const venta_detalle_entity_1 = require("./venta_detalle.entity");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => venta_detalle_entity_1.VentaDetalle, detalle => detalle.venta, { cascade: true }),
    __metadata("design:type", Array)
], Venta.prototype, "detalles", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => farmacia_entity_1.Farmacia, (farmacia) => farmacia.ventas, { eager: true }),
    (0, typeorm_1.JoinColumn)({ name: 'farmacia_id' }),
    __metadata("design:type", farmacia_entity_1.Farmacia)
], Venta.prototype, "farmacia", void 0);
